...
export default function RunTracePanel({ run = {}, stage, agents = [], language = 'en-US', loading = false, error, onApproval, onArtifactOpen, onDebug }) {
  ...
  return (
    <aside className="workspace-trace" aria-label="Run trace">
      ...
      <RunTimeline run={run} tasks={tasks} selectedTaskId={selectedTaskId} onTaskSelect={task => setSelectedTaskId(task.id)} language={language} />
